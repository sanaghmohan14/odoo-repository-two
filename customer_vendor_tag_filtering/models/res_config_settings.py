...
class ResConfigSettings(models.TransientModel):
    ...
    customer_tag_ids = fields.Many2many('res.partner.category',string='customer tag' ,relation='my_model_customer_rel_1')
    vendor_tag_ids = fields.Many2many('res.partner.category',string='vendor tag',relation='my_model_customer_rel_2')
